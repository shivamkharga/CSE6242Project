  ...
  describe('Procrastinators Recipe Panel', () => {
    ...
    it('should render recipe text when a recipe node is clicked', () => {
      ...
      cy.get('div#recipePanel')
        ...
        .and('contain', 'GO TO RECIPE')
  
      /*
        1. Get recipe 81 information from backend
        2. Ensure recipe 81 information is on recipe panel
      */
    })
    ...
    it('should render a second recipe when a second recipe node is clicked', () => {
      ...
      /*
      1. Get recipe 81 information from backend
      2. Get recipe 137739 informaiton
      3. Ensure recipe 81 information is not on recipe panel
      4. Ensure recipe 137739 informaiton is on recipe panel
    */
      // ensure the recipe panel changes from default to recipe information
      cy.get('div#recipePanel')
        .children()
